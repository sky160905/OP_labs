...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// add_first
			// 
			this->add_first->Location = System::Drawing::Point(49, 126);
			...
			// phone_first
			// 
			this->phone_first->Location = System::Drawing::Point(49, 86);
			...
			// date_first
			// 
			this->date_first->Location = System::Drawing::Point(195, 86);
			...
			// fullname_first
			// 
			this->fullname_first->Location = System::Drawing::Point(49, 39);
			...
			this->fullname_second->Location = System::Drawing::Point(49, 214);
			...
			// date_second
			// 
			this->date_second->Location = System::Drawing::Point(195, 261);
			...
			// phone_second
			// 
			this->phone_second->Location = System::Drawing::Point(49, 261);
			...
			// add_second
			// 
			this->add_second->Location = System::Drawing::Point(49, 310);
			...
			// show_second
			// 
			this->show_second->Location = System::Drawing::Point(195, 310);
			...
			// outp_first
			// 
			this->outp_first->Location = System::Drawing::Point(406, 23);
			this->outp_first->Multiline = true;
			this->outp_first->Name = L"outp_first";
			this->outp_first->ReadOnly = true;
			...
			this->label3->Location = System::Drawing::Point(46, 70);
			...
			this->label5->Location = System::Drawing::Point(192, 70);
			...
			this->label6->Location = System::Drawing::Point(192, 245);
			...
			// outp_second
			// 
			this->outp_second->Location = System::Drawing::Point(406, 195);
			this->outp_second->Multiline = true;
			this->outp_second->Name = L"outp_second";
			this->outp_second->ReadOnly = true;
			...
			// outp_sim
			// 
			this->outp_sim->Location = System::Drawing::Point(406, 366);
			this->outp_sim->Multiline = true;
			this->outp_sim->Name = L"outp_sim";
			this->outp_sim->ReadOnly = true;
			...
			this->label7->Location = System::Drawing::Point(403, 7);
			...
			this->label8->Location = System::Drawing::Point(403, 179);
			...
			this->label9->Location = System::Drawing::Point(403, 350);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(91, 13);
			this->label9->TabIndex = 27;
			this->label9->Text = L"Identical contacts";
			// 
			// plus2
			// 
			this->plus2->AutoSize = true;
			this->plus2->Location = System::Drawing::Point(17, 264);
			this->plus2->Name = L"plus2";
			this->plus2->Size = System::Drawing::Size(31, 13);
			this->plus2->TabIndex = 28;
			this->plus2->Text = L"+380";
			// 
			// plus1
			// 
			this->plus1->AutoSize = true;
			this->plus1->Location = System::Drawing::Point(17, 89);
			this->plus1->Name = L"plus1";
			this->plus1->Size = System::Drawing::Size(31, 13);
			this->plus1->TabIndex = 29;
			this->plus1->Text = L"+380";
			// 
			// MyForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(727, 531);
