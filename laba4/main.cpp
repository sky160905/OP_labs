...
int main() {
    ...
    do { //цикл для введення користувачем координат вектора, поки буде вибрано "+"
        ...
        cout << "Vect1 = (" << Vect1.getCoordX() << ", " << Vect1.getCoordY() << ")" << endl; // Виведення координат першого вектора
        Vect1 = Vect1 * 2; // Множення першого вектора на 2
        Vect3 = Vect1 - Vect2;   // Обчислення різниці між першим і другим векторами

        cout << "Vect2 = (" << Vect2.getCoordX() << ", " << Vect2.getCoordY() << ")" << endl;   // Виведення координат другого вектора
        cout << "Vect1_doubled = (" << Vect1.getCoordX() << ", " << Vect1.getCoordY() << ")" << endl; // Виведення координат першого вектора після множення на 2
        cout << "Vect3 = (" << Vect3.getCoordX() << ", " << Vect3.getCoordY() << ")" << endl;     // Виведення координат третього вектора та його довжини
        cout << "Length of Vect3 = " << Vect3.getLen() << endl;
